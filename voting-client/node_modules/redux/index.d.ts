...
export function compose<A, R>(f1:(b:A) => R,
                              f2:(...args:any[]) => A):(...args:any[]) => R;

export function compose<A, B, R>(f1:(b:B) => R,
                                 f2:(a:A) => B,
                                 f3:(...args:any[]) => A):(...args:any[]) => R;

export function compose<A, B, C, R>(f1:(b:C) => R,
                                    f2:(a:B) => C,
                                    f3:(a:A) => B,
                                    f4:(...args:any[]) => A):(...args:any[]) => R;

export function compose<R>(f1:(a:any) => R,
